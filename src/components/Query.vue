<template>
  <div class="query_box">
    ...
    <div class="dropdown-menu">
      <vSelect
        v-if="completer.show"
        v-model="result.editor_mode_selected"
        :options="result.editor_modes"
      ></vSelect>
    </div>
    ...
    <div id="show_result">
      <editor v-if="result.msg != ''" v-model="result.msg" lang="text" width="100%" height="100px"></editor>
      <vtable
        v-if="result.tableData.length>0"
        :table-data="result.tableData"
